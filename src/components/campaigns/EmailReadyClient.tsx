...
function ReadyLayoutPreviewIcon({ layoutKey, selected }: { layoutKey: EmailLayoutStyle; selected: boolean }) {
  ...
  if (layoutKey === "paper") return (
    <svg width="40" height="54" viewBox="0 0 40 54" fill="none"><rect width="40" height="54" rx="3" fill="#faf8f4"/><rect width="40" height="22" rx="3" fill={accent}/><rect x="4" y="13" width="20" height="4" rx="1.5" fill="white" opacity=".9"/><rect x="4" y="18" width="13" height="2.5" rx="1" fill="white" opacity=".6"/><rect x="3" y="25" width="7" height="7" rx="1" fill={line}/><rect x="13" y="26" width="20" height="2.5" rx="1" fill={line}/><rect x="13" y="30" width="14" height="2" rx="1" fill={line} opacity=".5"/><rect x="3" y="35" width="7" height="7" rx="1" fill={line}/><rect x="13" y="36" width="20" height="2.5" rx="1" fill={line}/><rect x="13" y="40" width="14" height="2" rx="1" fill={line} opacity=".5"/><rect width="40" height="7" rx="3" y="47" fill={dark}/></svg>
  );
  if (layoutKey === "dark") return (
    <svg width="40" height="54" viewBox="0 0 40 54" fill="none"><rect width="40" height="54" rx="3" fill={dark}/><rect width="40" height="22" rx="3" fill="#1a1a1a"/><rect x="7" y="7" width="26" height="6" rx="1.5" fill="white" opacity=".85"/><rect x="11" y="15" width="18" height="2.5" rx="1" fill="white" opacity=".4"/><rect width="40" height="3" y="22" fill={accent}/><rect x="0" y="27" width="19" height="14" fill="#1e1e1e"/><rect x="21" y="27" width="19" height="14" fill="#1e1e1e"/><rect x="0" y="43" width="19" height="11" rx="3" fill="#1a1a1a"/><rect x="21" y="43" width="19" height="11" rx="3" fill="#1a1a1a"/></svg>
  );
  if (layoutKey === "split") return (
    <svg width="40" height="54" viewBox="0 0 40 54" fill="none"><rect width="40" height="54" rx="3" fill="#f8fafc"/><rect width="23" height="22" rx="3" fill={dark}/><rect x="23" width="17" height="22" rx="3" fill={accent} opacity=".7"/><rect x="3" y="7" width="16" height="4" rx="1.5" fill="white" opacity=".9"/><rect x="3" y="13" width="11" height="2.5" rx="1" fill="white" opacity=".55"/><rect x="0" y="24" width="40" height="1" fill={line}/><rect x="2" y="28" width="11" height="13" rx="1" fill={line}/><rect x="15" y="28" width="11" height="13" rx="1" fill={line}/><rect x="28" y="28" width="11" height="13" rx="1" fill={line}/><rect x="4" y="44" width="32" height="2.5" rx="1" fill={line} opacity=".5"/></svg>
  );
  return (
    <svg width="40" height="54" viewBox="0 0 40 54" fill="none"><rect width="40" height="54" rx="3" fill="#0c0c0c"/><rect width="40" height="20" rx="3" fill={accent} opacity=".55"/><rect width="40" height="7" y="20" fill="#0c0c0c"/><rect x="8" y="22" width="24" height="3.5" rx="1" fill="white" opacity=".8"/><rect x="12" y="27" width="16" height="2" rx="1" fill="white" opacity=".35"/><rect width="40" height="3" y="31" fill={accent}/><rect x="0" y="34" width="19" height="10" fill="#161616"/><rect x="21" y="34" width="19" height="10" fill="#161616"/><rect x="0" y="45" width="19" height="9" rx="3" fill="#161616"/><rect x="21" y="45" width="19" height="9" rx="3" fill="#161616"/></svg>
  );
}
