    ...
    <div className="mx-auto max-w-3xl space-y-10">
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        <div className="rounded-xl border border-zinc-200 bg-white p-5 shadow-sm">
          <p className="text-sm text-ink-muted">Campaigns</p>
          <p className="mt-2 text-3xl font-semibold">{campaignCount ?? 0}</p>
          <Link href="/dashboard/campaigns" className="mt-4 inline-block text-sm font-medium text-accent hover:text-accent-hover">
            View campaigns →
          </Link>
        </div>
        <div className="rounded-xl border border-zinc-200 bg-white p-5 shadow-sm">
          <p className="text-sm text-ink-muted">Audiences</p>
          <p className="mt-2 text-3xl font-semibold">{audienceCount ?? 0}</p>
          <Link href="/dashboard/audience/phones" className="mt-4 inline-block text-sm font-medium text-accent hover:text-accent-hover">
            Manage phone lists →
          </Link>
        </div>
      </div>
