...
import { EmailAudienceDetail } from "./ui";

type Props = { params: Promise<{ id: string }> };

export default async function EmailAudienceDetailPage({ params }: Props) {
  ...
  return (
    <div className="mx-auto max-w-3xl space-y-6">
      <Link href="/dashboard/audience/emails" className="text-sm text-ink-muted hover:text-ink">
        {t("backToLists")}
      </Link>
      <EmailAudienceDetail
        audienceId={id}
